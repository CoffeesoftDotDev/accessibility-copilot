# 🎵 Album Viewer — Accessibility Audit: Before / After

> Back to the [main README](../README.md) for setup and scenario steps.

## Context

The **Album Viewer** app is a music store built with Vue.js / TypeScript.
It looks perfectly functional visually but contains **21 intentional WCAG 2.2 violations** designed as a hands-on exercise for automated accessibility auditing with **GitHub Copilot agentic workflows**.

This document describes each issue, its concrete user impact, and the expected fix.

> **Reference**: [awesome-copilot/a11y.instructions.md](https://github.com/github/awesome-copilot/blob/main/instructions/a11y.instructions.md)
